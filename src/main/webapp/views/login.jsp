...
<body>
	<nav class="navbar navbar-default navbar-light navbar-expand-sm text-center " style="background-color: #e3f2fd;">
		...
		<ul class="nav navbar-nav navbar-center style="color:#1aa743;">
		  <li><img class="img-rounded" src="sporty-shoe.png" alt="Sporty Shoes" width="70" height="40">	</li>
      </ul>
	...
	<h3> Welcome To Sporty Shoes</h3>
		...
		<div class="form-group text-center">
			...
			<a href="/changePassword" class="btn btn-primary" role="button" data-bs-toggle="button">Change Password</a>

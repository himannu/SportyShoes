...
<body >
	<nav class="navbar navbar-default navbar-light navbar-expand-sm" style="background-color: #e3f2fd;">
      ...
      <div class="nav navbar-nav navbar-center text-center" style="color:#1aa743;">	
		...
		<form:form action="register"  method="POST"  modelAttribute="userForm" >
			...
			<div class="form-group">	
		 	...
		 	<div class="form-group">
				...
				<input class="form-control" type="text" required="required" name="phoneNumber"  placeholder="phone number"  />
